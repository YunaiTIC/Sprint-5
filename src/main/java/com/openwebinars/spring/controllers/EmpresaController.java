...
public class EmpresaController {
  ...
  //JUNIT
  //public String findAll(Empresa empresa){
  //empresa.addAttribute("empresas",this.empresaService.findAll());
  //return "empresa-list";
  ...
  //OPENAPI
  //@Tag(name ="Employee", description ="Employee API REST")
  ...
  //JUNIT
  //public String findById(@PathVariable Long id, Empresa empresa){
  //Empresa empresa = this.empresaService.findById(id).orElseThrow();
  //empresa.addAttribute("empresas",empresa);
  //return "empresa-list";
